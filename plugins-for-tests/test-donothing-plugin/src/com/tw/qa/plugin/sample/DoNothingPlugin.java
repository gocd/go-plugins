...
@Extension
public class DoNothingPlugin implements PluginDescriptorAware {
    Console console = new Console();
    Logger logger = Logger.getLoggerFor(DoNothingPlugin.class);

    static {
        Logger.getLoggerFor(DoNothingPlugin.class).info("Boo");
    }
